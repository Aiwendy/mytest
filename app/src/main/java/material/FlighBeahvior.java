...
public class FlighBeahvior extends AppBarLayout.Behavior {

    private static final String TAG = FlighBeahvior.class.getName();
    ...
    public FlighBeahvior() {
    }

    public FlighBeahvior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child, View target,
        ...
        //target.scrollBy(velocityX,velocityY+=10);
        // child.setScrollY(target.getScrollY()+10);
