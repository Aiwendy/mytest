...
import com.dreamer.http.api.RxRetrofitApp;
...
import http.cookie.CookieResulte;
 ...
 */
public class ProgressSubscriber<T> extends DefaultSubscriber<T> implements  Observer<T> {
