...
import exception.HttpTimeException;
...
public abstract class BaseApi<T> implements Function<BaseResultEntity<T>, T> {
    ...
    /*回调*/
    private SoftReference<HttpListener> listener;
    /*是否能取消加载框*/
    ...
    public BaseApi(HttpListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public SoftReference<HttpListener> getListener() {
        return listener;
    }
